...
# REVISED DATE:  03/15/2019 (finished)
#          Rev: 03/18/2019 (incorporated code review corrections: div/0)
...
def calculates_results_stats(results_dic):
    ...
    # Calculates % correct for matches (catch zero images condition)
    ...
    # Calculates % correct dogs (catch zero images condition)
    ...
    # Calculates % correct breed of dog (catch zero images condition)
    if results_stats_dic['n_dogs_img'] > 0:
    ...
    # Calculates % correct not-a-dog images when no 'not a dog' images were submitted 
    if results_stats_dic['n_notdogs_img'] > 0:
        results_stats_dic['pct_correct_notdogs'] = (results_stats_dic['n_correct_notdogs'] /
                                                results_stats_dic['n_notdogs_img'])*100.0
    else:
        results_stats_dic['pct_correct_notdogs'] = 100 - results_stats_dic['pct_correct_breed']

        

    # Return results_stats_dic dictionary created with this function 
